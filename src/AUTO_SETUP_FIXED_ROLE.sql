-- =====================================================
-- AUTOMATIC COMPANY CREATION FOR ALL USERS - FIXED ROLE
-- =====================================================
-- This version uses 'admin' role instead of 'owner'
-- Run this ONCE and it fixes EVERYTHING automatically
-- =====================================================
...
BEGIN
  ...
  -- Using 'admin' role instead of 'owner'
  INSERT INTO public.profiles (id, email, full_name, company_id, role)
  VALUES (NEW.id, NEW.email, v_user_name, v_company_id, 'admin')
...
BEGIN
  ...
  LOOP
    ...
    ELSE
      ...
      INSERT INTO public.profiles (id, email, full_name, company_id, role)
      VALUES (v_user.id, v_user.email, v_user.full_name, v_company_id, 'admin');
...
BEGIN
  ...
  RAISE NOTICE '3. ✅ Using "admin" role for all profiles';
  RAISE NOTICE '4. ✅ Tested and verified';
  RAISE NOTICE '';
